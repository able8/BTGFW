...
![Billing](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/Billing.jpg)

## 2.3 购买服务器

点击vultr网页右上角的蓝色+图标即可为账户添加服务器。
![addServer](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/addServer.jpg)
...
![服务器地点](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/服务器地点.jpg)

第二个选项为选择服务器类型（Server Type），即选择服务器操作系统。建议选择Debian 7 x64，默认没有防火墙，会减少很多麻烦。
![服务器类型](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/服务器类型.jpg)
...
![服务器大小](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/服务器大小.jpg)
...
![服务器标签](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/服务器标签.jpg)
...
![服务器信息](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/服务器信息.jpg)
...
![autoSwitch](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/autoSwitch.jpg)

情景模式中的proxy配置如下图所示，其中127.0.0.1:1080为SSR代理地址，只有流向这个地址的流量SSR才会处理。
![proxy](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/proxy.jpg)

设定中的初始情景模式选择auto switch，如图所示。这样当检测到目标地址在GFW列表中的时候chrome会让其走SSR代理。否则直连。
![初始情景模式](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/初始情景模式.jpg)

然后重启chrome，保证SwitchyOmega运行在auto switch模式，否则可能无法正常使用，常见现象有无法访问国外网站、导致访问国内网站速度变慢或无法访问内网等。如图所示：
![确定状态](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/确定状态.jpg)
...
![代理模式直连模式](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/代理模式直连模式.jpg)

右键小飞机代理规则改为“全局”，如图所示：
![全局代理规则](https://raw.githubusercontent.com/siaimes/BlogImages/master/自建梯子教程/全局代理规则.jpg)
